defmodule Lex.Runtime.Response.Card do
  ...
  @moduledoc """
  A struct reperesenting a Lex Response Card
  """
...
defmodule Lex.Runtime.Response.ElicitIntent  do
  @moduledoc """
  A struct reperesenting a Lex ElicitIntent response
  """
  ...
  @spec cast(String.t, map) :: %__MODULE__{}
...
defmodule Lex.Runtime.Response.ConfirmIntent  do
  ...
  @moduledoc """
  A struct reperesenting a Lex ConfirmIntent response
  """
...
defmodule Lex.Runtime.Response.ElicitSlot  do
  @moduledoc """
  A struct reperesenting a Lex ElicitSlot response
  """
...
defmodule Lex.Runtime.Response.Fulfilled  do
  ...
  @moduledoc """
  A struct reperesenting a Lex Fulfilled response. 
  """
...
defmodule Lex.Runtime.Response.ReadyForFulfillment  do
  ...
  @moduledoc """
  A struct reperesenting a Lex ReadyForFulfillment response.
  """
...
defmodule Lex.Runtime.Response.Failed do
  ...
  @moduledoc """
  A struct reperesenting a Lex Failed response
  """
  @type t :: %__MODULE__{
    user_id: String.t,
    intent_name: String.t, 
  ...
  defstruct [ :user_id, :intent_name, :session_attributes, :message, :slots ]
...
defmodule Lex.Runtime.Response.Error do
  @moduledoc """
  A struct reperesenting a Lex Error response.
  """
  @type t :: %__MODULE__{
    user_id: String.t,
    data: term
  ...
  @spec cast(String.t, term) :: %__MODULE__{}
...
defmodule Lex.Runtime.Response do
  ...
  @type t :: %Response.ElicitIntent{} |
    %Response.ConfirmIntent{} |
    %Response.ElicitSlot{} |
    %Response.Fulfilled{} |
    %Response.ReadyForFulfillment{} |
    %Response.Failed{} |
    %Response.Error{}
  ...
  @spec cast(user_id, context, json) :: __MODULE__.t
