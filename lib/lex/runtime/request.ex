defmodule Lex.Runtime.Request do
  ...
  """
  @spec new(__MODULE__.t) :: __MODULE__.t
  def new(params \\ %{}) do
  ...
  Sets the bot name
  """
  @spec set_bot_name(__MODULE__.t, String.t) :: __MODULE__.t
  ...
  """
  @spec set_bot_alias(__MODULE__.t, String.t) :: __MODULE__.t
  ...
  """
  @spec set_user_id(__MODULE__.t, String.t) :: __MODULE__.t
  ...
  """
  @spec set_context(__MODULE__.t, String.t) :: __MODULE__.t
  ...
  * CustomPayload — The message contains a custom format that you have created for 
  ...
  """
  @spec set_time_zone(__MODULE__.t, String.t) :: __MODULE__.t
  ...
  """
  @spec set_text_input(__MODULE__.t, String.t) :: __MODULE__.t
  ...
  """
  @spec set_session_attributes(__MODULE__.t, String.t) :: __MODULE__.t
  ...
  """
  @spec set_request_attributes(__MODULE__.t, String.t) :: __MODULE__.t
  ...
  send the request.
  """
  @spec send(__MODULE__.t) :: Lex.Runtime.Response.t
